...
import { Custom_Validators } from 'src/app/validators/validators';
@Component({
...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,private shoppingFormService:ShoppingFormService,
      ...
      customer: this.formBuilder.group({
        firstName: new FormControl('', 
                              [Validators.required, 
                               ...
                               Custom_Validators.notOnlyWhitespace]),
